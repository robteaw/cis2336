...
<head>
	...
	<style type=
	text/css" title="text/css" media="all">
	label {
		font-weight: bold;
		color: #300ACC;
	}
...
<form action="handle_form.php" method="post">
	...
	<p><label for="gender">Gender: </label><input type="radio" name="gender" value="M" />
		Male <input type="radio" name="gender" value="F" /> Female</p>
